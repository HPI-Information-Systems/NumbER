...
df = pd.read_csv("./NumbER/scripts/runs_lightgbm.csv")
...
#filtered_df = filtered_df[filtered_df["dataset"].isin(["baby_products_all", "baby_products_merged", "books3_all", "books3_merged", "x2_all", "x2_merged", "x3_all", "x3_merged"])]
