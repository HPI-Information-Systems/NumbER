...
df = pd.read_csv("./NumbER/scripts/runs_restart.csv") # experiments for quality
...
filter= {
	...
	'textual_config_finetune_formatter': 'NumbER.matching_solutions.embitto.formatters.pair_based_ditto_formatter',
